  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-2xl sm:text-3xl lg:text-4xl font-space-grotesk font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-b from-slate-900 via-slate-800 to-slate-500 dark:from-white dark:via-slate-200 dark:to-slate-400 whitespace-nowrap leading-[1.05]"
      >
        {title}
      </motion.h2>
      ...
      <motion.p
        ...
        className="text-base sm:text-lg text-slate-500 dark:text-zinc-400 font-outfit font-light leading-relaxed max-w-2xl text-balance"
      >
        {description}
      </motion.p>
    </motion.div>
