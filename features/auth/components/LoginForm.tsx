...
const inputBase = "pl-11 pr-4 h-12 rounded-2xl border-zinc-300 dark:border-white/10 bg-zinc-50 dark:bg-white/5 focus-visible:ring-2 focus-visible:ring-violet-500/20 focus-visible:border-violet-500 font-outfit transition-all placeholder:text-zinc-400 dark:placeholder:text-zinc-600 text-zinc-900 dark:text-white text-sm shadow-none";
const labelBase = 'text-[11px] font-black font-space-grotesk uppercase tracking-widest text-zinc-400 dark:text-zinc-500';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="relative py-4">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-background px-3 font-space-grotesk font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Or continue with</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <motion.button
            ...
            className="flex items-center justify-center gap-3 h-12 rounded-2xl border border-zinc-300 dark:border-white/10 bg-background hover:bg-zinc-50 dark:hover:bg-white/5 transition-all duration-300 cursor-pointer"
          >
            ...
            <span className="text-xs font-outfit font-bold text-zinc-900 dark:text-white">Google</span>
          </motion.button>
          ...
          >
            ...
            <span className="text-xs font-outfit font-bold text-zinc-900 dark:text-white">Facebook</span>
          </motion.button>
        </div>
