...
export default async function AiAssistantPage() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-6">
        <h1 className="text-3xl font-space-grotesk font-extrabold tracking-tight bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent">AI Study Assistant</h1>
      ...
      <div className="h-full bg-card/40 backdrop-blur-md border border-white/5 rounded-2xl shadow-xl overflow-hidden">
