...
export default function ProfileClient({ profile }: { profile: any }) {
  ...
  return (
    <motion.div 
      ...
      className="max-w-7xl mx-auto pb-12 px-4 sm:px-6 relative h-full"
    >
      ...
      <motion.div variants={fadeInUp} className="relative mt-4 mb-8">
        <div className="h-48 md:h-64 rounded-[2.5rem] w-full overflow-hidden relative glass-card border border-white/5 shadow-md">
        ...
        <div className="px-8 sm:px-12 flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-8 -mt-20 md:-mt-24 relative z-10 w-full">
          <div className="relative group">
            <div className="w-40 h-40 md:w-48 md:h-48 rounded-[2rem] bg-zinc-100 dark:bg-zinc-900 border-8 border-[#0d0e17] overflow-hidden relative shadow-md flex-shrink-0 group-hover:scale-105 transition-transform duration-500 cursor-pointer">
              {profile?.avatar_url && !imgError ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-violet-500 to-indigo-500 text-white text-6xl font-bold">
          ...
          <div className="flex-1 text-center md:text-left pb-2 flex flex-col md:flex-row md:items-end justify-between w-full gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold font-space-grotesk tracking-tight text-foreground mb-3 flex items-center justify-center md:justify-start gap-3">
                {profile?.username || 'Student'}

                {profile?.level && (
                   <span className="px-2.5 py-1 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-500 text-sm font-bold tracking-widest uppercase">
                     Lvl {profile.level}
                   </span>
                )}
              </h1>
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-muted-foreground font-outfit text-sm font-semibold">
                <span className="flex items-center gap-1.5 px-3 py-1 rounded-lg bg-violet-500/10 text-violet-600 dark:text-violet-400 uppercase tracking-widest text-[11px] font-bold shadow-sm">
        ...
        >
          <div className="p-6 md:p-8 rounded-[2rem] bg-gradient-to-br from-[#0f101a] via-[#0c0c14] to-[#121425] relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <Link href="/profile/edit" className="relative z-10 w-full md:w-auto flex-shrink-0">
              <div className="relative group">
                <button className="relative w-full md:w-auto h-12 px-8 rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold font-outfit text-sm flex items-center justify-center gap-3 cursor-pointer transition-all duration-300 group-hover:from-violet-500 group-hover:to-indigo-500 overflow-hidden">
        ...
        <div className="lg:col-span-4 space-y-6 lg:space-y-8">
          ...
          <motion.div variants={fadeInUp} className="p-[1px] rounded-[2.5rem] bg-gradient-to-br from-violet-500/30 via-white/5 to-transparent">
            <div className="bg-gradient-to-br from-[#0f101a] via-[#0c0c14] to-[#121425] rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden h-full shadow-md group">
              ...
              <h3 className="text-[11px] font-bold font-outfit uppercase tracking-[0.25em] text-foreground mb-10 flex items-center gap-3 relative z-10">
                <div className="w-9 h-9 rounded-xl bg-violet-500/10 flex items-center justify-center shadow-inner border border-violet-500/20">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-5 group">
                <div className="w-12 h-12 rounded-xl bg-violet-500/10 flex items-center justify-center text-violet-500 transition-colors shadow-sm">
                  <Mail className="w-5 h-5" />
                </div>
                <div className="min-w-0">
                  <p className="text-[10px] font-bold font-outfit text-muted-foreground uppercase tracking-widest leading-none mb-1.5 opacity-70">Email Address</p>
                  <p className="text-[15px] font-bold font-outfit text-foreground truncate">{profile?.email || 'N/A'}</p>
                </div>
              </div>
              <div className="flex items-center gap-5 group">
                <div className="w-12 h-12 rounded-xl bg-indigo-500/10 flex items-center justify-center text-indigo-500 transition-colors shadow-sm">
                  <Globe className="w-5 h-5" />
                </div>
                <div className="min-w-0">
                  <p className="text-[10px] font-bold font-outfit text-muted-foreground uppercase tracking-widest leading-none mb-1.5 opacity-70">Public Profile</p>
                  <p className="text-[15px] font-bold font-outfit text-foreground truncate">opticepx.io/@{profile?.username || 'user'}</p>
                </div>
              </div>
              <div className="flex items-center gap-5 group">
                <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-500 transition-colors shadow-sm">
                  <Calendar className="w-5 h-5" />
                </div>
                <div className="min-w-0">
                  <p className="text-[10px] font-bold font-outfit text-muted-foreground uppercase tracking-widest leading-none mb-1.5 opacity-70">Joined Platform</p>
                  <p className="text-[15px] font-bold font-outfit text-foreground truncate">March 2024</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <motion.div variants={fadeInUp} className="p-[1px] rounded-[2.5rem] bg-gradient-to-bl from-indigo-500/30 via-white/5 to-transparent">
            <div className="bg-gradient-to-br from-[#0c0c14] via-[#08090f] to-[#14162a] rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden h-full shadow-md group">
              ...
              <div className="flex justify-between items-center mb-10 relative z-10">
                <h3 className="text-[11px] font-bold font-outfit uppercase tracking-[0.25em] text-foreground flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-indigo-500/10 flex items-center justify-center shadow-inner border border-indigo-500/20">
            ...
            <div className="grid grid-cols-2 gap-4 relative z-10">
              {[
                ...
                <div key={i} className="flex flex-col items-center justify-center p-5 rounded-2xl bg-white/[0.03] dark:bg-white/[0.02] border border-white/5 transition-all duration-300 hover:-translate-y-1 cursor-pointer group relative overflow-hidden shadow-sm">
                  ...
                  <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center mb-3 shadow-inner transition-all group-hover:scale-110 duration-300 relative z-10", `bg-${ach.color}-500/10 text-${ach.color}-500`)}>
                    {ach.icon}
                  </div>
                  <span className="text-[11px] font-bold font-space-grotesk text-foreground text-center mb-1 relative z-10">{ach.label}</span>
                  <span className="text-[9px] font-bold font-outfit text-muted-foreground uppercase tracking-widest text-center relative z-10">{ach.desc}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <motion.div variants={fadeInUp} className="p-[1px] rounded-[2.5rem] bg-gradient-to-tr from-emerald-500/30 via-white/5 to-violet-500/20">
            ...
            <div className="p-8 md:p-10 md:pt-8 bg-zinc-50/50 dark:bg-transparent">
              <div className="space-y-12 relative z-0 before:absolute before:-z-10 before:left-[23px] before:top-4 before:bottom-6 before:w-[2px] before:bg-violet-200 dark:before:bg-[#2e1d5a]">
                {[
                  { 
                    title: 'Completed UI/UX Fundamentals Quiz', 
                    date: '2 hours ago', 
                    icon: <CheckCircle2 className="w-5 h-5" />, 
                    color: 'emerald', 
                    desc: 'Scored 98%. Earned 50 XP and moved up to Top 15% in Global Rank.' 
                  },
                  { 
                    title: 'Joined "Math Warriors" Study Room', 
                    date: 'Yesterday, 4:30 PM', 
                    icon: <Users className="w-5 h-5" />, 
                    color: 'violet', 
                    desc: 'Collaborated for 2 hours on advanced calculus problems.' 
                  },
                  { 
                    ...
                    color: 'zinc', 
                    desc: 'Added new avatar and completed profile details.' 
                  }
                ].map((item, i) => (
